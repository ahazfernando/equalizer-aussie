    ...
    <section className="relative overflow-hidden rounded-3xl mx-4 mt-4 mb-4" style={{ backgroundColor: '#C9184A' }}>
      ...
      <div className="container mx-auto px-4 py-8 md:py-10 lg:py-12 relative z-[2]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center relative">
          ...
          {/* Right Side - Image */}
          <div className="relative lg:absolute lg:-right-20 xl:-right-28 2xl:-right-32 lg:top-1/2 lg:-translate-y-1/2 w-full lg:w-[45%] xl:w-[50%] 2xl:w-[55%] overflow-visible order-first lg:order-last">
            <div className="relative w-full h-[300px] sm:h-[350px] lg:h-[350px] xl:h-[450px] 2xl:h-[550px]">
              <Image
