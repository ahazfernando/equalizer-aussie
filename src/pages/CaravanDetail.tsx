        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div>
                <span className="badge-sage mb-2">{caravan.series} Series</span>
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-5 h-5 ${
                          i < Math.floor(rating) ? "fill-gold text-gold" : "text-border"
                        }`}
                      />
                    ))}
                  </div>
            ...
            <TabsContent value="specs" className="space-y-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {caravan.specs.map((specGroup) => (
                  <div key={specGroup.category} className="card-premium p-6">
                    <h3 className="font-heading font-semibold mb-4">{specGroup.category}</h3>
            ...
            <TabsContent value="variants" className="space-y-6">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {caravan.variants.map((variant) => (
                  <div key={variant.name} className="card-premium p-6">
